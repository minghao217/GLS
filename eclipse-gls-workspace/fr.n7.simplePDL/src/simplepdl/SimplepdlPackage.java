...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ALLOCATION__COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ALLOCATION__RESSOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ALLOCATION__WORKDEFINITION = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ALLOCATION_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int ALLOCATION_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Allocation#getCount <em>Count</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Count</em>'.
	 * @see simplepdl.Allocation#getCount()
	 * @see #getAllocation()
	 * @generated
	 */
	EAttribute getAllocation_Count();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute ALLOCATION__COUNT = eINSTANCE.getAllocation_Count();
