...
public class PDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (count=EInt ressource=[Ressource|EString])
	 */
	protected void sequence_Allocation(ISerializationContext context, Allocation semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SimplepdlPackage.Literals.ALLOCATION__COUNT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimplepdlPackage.Literals.ALLOCATION__COUNT));
		...
		feeder.accept(grammarAccess.getAllocationAccess().getCountEIntParserRuleCall_2_0(), semanticObject.getCount());
		feeder.accept(grammarAccess.getAllocationAccess().getRessourceRessourceEStringParserRuleCall_4_0_1(), semanticObject.eGet(SimplepdlPackage.Literals.ALLOCATION__RESSOURCE, false));
		feeder.finish();
	}
	...
	protected void sequence_Ressource(ISerializationContext context, Ressource semanticObject) {
		...
		feeder.accept(grammarAccess.getRessourceAccess().getCountEIntParserRuleCall_3_0(), semanticObject.getCount());
		feeder.finish();
	}
