...
public class PetriNetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PetriNetPackage.PLACE: {
				...
				if (result == null) result = casePetriNetElt(place);
			...
			case PetriNetPackage.TRANSITION: {
				...
				if (result == null) result = casePetriNetElt(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetriNetPackage.NOEUD: {
				...
				if (result == null) result = casePetriNetElt(noeud);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetriNetPackage.ARC: {
				...
				if (result == null) result = casePetriNetElt(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetriNetPackage.PETRI_NET_ELT: {
				PetriNetElt petriNetElt = (PetriNetElt)theEObject;
				T result = casePetriNetElt(petriNetElt);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Elt</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Elt</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePetriNetElt(PetriNetElt object) {
		return null;
	}
