...
public class PetriNetFactoryImpl extends EFactoryImpl implements PetriNetFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PetriNetPackage.TYPE_ARC:
				return createTypeArcFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case PetriNetPackage.TYPE_ARC:
				return convertTypeArcToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public TypeArc createTypeArcFromString(EDataType eDataType, String initialValue) {
		TypeArc result = TypeArc.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertTypeArcToString(EDataType eDataType, Object instanceValue) {
